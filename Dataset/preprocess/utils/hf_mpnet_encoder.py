...
from dataset.preprocess.utils.constants import get_finetuned_text_dir
...
class FinetunedMPNetTextEncoder:
    ...
    def __init__(self, model_dir: str, device: torch.device | None = None, max_length: int = 128) -> None:
