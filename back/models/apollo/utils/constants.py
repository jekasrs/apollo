...
# По умолчанию мультимодальность (лучше accuracy/F1 на MELD, см. results/RESULTS.md)
MODALITIES = "at"
...
AUG_APPLY_PROB = 0.65
AUG_AUDIO_STD = 0.028
# Режим только аудио (modalities ``a``): слабее шум по эмбеддингам — иначе легко теряется сигнал классов.
AUG_AUDIO_STD_MODALITY_SOLO = 0.014
AUG_TEXT_STD = 0.028
